...
// type: 'multiple' | 'fill' | 'short' | 'match'
...
export const questions = [
  ...
  /* ══════════════════════════════════════════════════
     ★ 순서 단답 — match/short 통합 (505~519)
  ══════════════════════════════════════════════════ */

  { id:505, type:'match', lecture:'10강', category:'독성동태',
  ...
  { id:506, type:'match', lecture:'12-13강', category:'반도체 공정',
    question:'포토리소그래피(포토공정)의 핵심 4단계 순서를 → 로 구분하여 쓰시오.\n(PR 도포 / 소프트베이크 / 노광 / 현상)',
    answer:'PR도포→소프트베이크→노광→현상',
    accepts:['PR도포→소프트베이크→노광→현상','도포→소프트베이크→노광→현상'],
    explanation:'포토공정: PR 도포(스핀 코팅) → 소프트 베이크 → 노광(UV) → 현상(TMAH). 현상 후 하드 베이크가 이어짐.' },

  { id:507, type:'short', lecture:'11-12강', category:'경영시스템',
